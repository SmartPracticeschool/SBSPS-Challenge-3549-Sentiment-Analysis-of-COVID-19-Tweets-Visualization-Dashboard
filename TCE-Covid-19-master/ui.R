...
source("UI/ui_safe.R", local = TRUE)
...
ui <- fluidPage(
  ...
  navbarPage(
    title       = div("TCE COVID-19 Statistical Analysis Simulator App", style = "padding-left: 10px"),
    inverse = TRUE,
    collapsible = TRUE,
    fluid       = TRUE,
    ...
    tabPanel("Protect Ourself", page_safe, value = "page-safe"),
     tabPanel("Quiz", page_quiz, value = "page-quiz"),
   
    tabPanel("About", page_about, value = "page-about"),
    tags$script(HTML("var header = $('.navbar > .container-fluid');
    header.append('<div style=\"float:right\"><a target=\"_blank\" href=\"https://www.youtube.com/c/AhmadBazzi\"><img src=\"logo.png\" alt=\"alt\" style=\"float:right;width:33px;padding-top:10px;margin-top:-50px;margin-right:10px\"> </a></div>');
    console.log(header)")
    )
  )
)